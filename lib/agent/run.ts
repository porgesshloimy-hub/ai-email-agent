    ...
    const messages: LlmMessage[] = [
      {
        ...
        content: [
          ...
          "Do not confuse the rule above with a customer asking whether you understand their business, or questioning something stated earlier in the thread. That is a factual question, answerable from grounded information (business knowledge, pinned context, search_context results — especially anything the customer themselves already stated), not a personal decision, preference, or availability question requiring the account holder's own input. If grounded information confirms your prior understanding was accurate, say so directly and specifically — restate the actual facts you have, in your own words, rather than apologizing for an assumption you did not actually get wrong, discarding what you already correctly know, or asking the customer to re-explain something they've already told you. Only ask for whatever specific detail is genuinely still missing or actually contradicted, never the whole picture over again merely because the customer's question was phrased as doubt.",
          "</safety_rules>",
